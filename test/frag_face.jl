...
@testset "@code_warntype for frag_face" begin
    err = nothing
    try
        @inferred TGW.frag_face(V, EV, Fe)
    catch err
    end
...
@testset "Generic result of frag_face" begin
    result = TGW.frag_face(V, EV, FE, [[2,3,4,5]],2)
...
@testset "Specific result of frag_face" begin
    x_test = "70724daba19fb7b14822cc8c65e3923ce9cd3d11eed0dada4dcb3b56b9650718"
    y_test = "3ebac7417b88c28234751da17f134eca1d06107d6d38c0a3514d1c55c2a70254"
    z_test = "33b022566a092c076de957b864c83969530ed93bf242706e9bea7b7207813ffa"
    result = TGW.frag_face(V, EV, FE, [[2,3,4,5]],2)
